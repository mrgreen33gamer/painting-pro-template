    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Brushcraft Painting Co. - Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Texas Hill Country homeowners — paint selection, maintenance schedules, and what to expect from a painting project.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a trusted painting company in the Texas Hill Country?
            </p>
            <p className={styles.blogCTABody}>
              We've been painting New Braunfels-area homes and businesses with EPA Lead-Safe Certified crews since 2014. Free estimate, no obligations.
            </p>
