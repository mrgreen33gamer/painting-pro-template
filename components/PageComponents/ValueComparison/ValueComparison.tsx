...
const DEFAULT_ROWS: ComparisonRow[] = [
  { feature: 'Upfront, written pricing (no hourly billing)', us: true,  others: false },
  { feature: '5-Year Workmanship Guarantee',                 us: true,  others: false },
  { feature: 'Free in-home color consultation',              us: true,  others: 'Sometimes' },
  { feature: 'No service contracts required',                us: true,  others: false },
  { feature: 'EPA Lead-Safe Certified crews',                us: true,  others: false },
  { feature: 'Written quote before work begins',              us: true,  others: false },
  { feature: 'Premium, professional-grade paint',             us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Brushcraft vs. The Other Guys' }: ValueComparisonProps) {
  return (
