...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Brushcraft Painting Co.',
  address       = 'New Braunfels, TX 78130',
  phone         = '(830) 900-7400',
  email         = 'hello@brushcraftpaintingtx.com',
  googleMapsUrl = 'https://maps.google.com/?q=Brushcraft+Painting+Co+New+Braunfels+TX',
  hours         = DEFAULT_HOURS,
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of the Texas Hill Country with EPA Lead-Safe Certified painters.
          </p>
        </div>
