...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Home or Business Needs',
  subheading = 'From single-room refreshes to full exterior repaints, Brushcraft handles it all — on time, on price.',
