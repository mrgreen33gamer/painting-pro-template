...
const DEFAULT_GUARANTEES: Guarantee[] = [
  {
    ...
    description:
      "You get a firm, written price before we start — no hourly billing, no surprise add-ons. What we quote is what you pay.",
  },
  {
    icon: faShieldHalved,
    title: "5-Year Workmanship Guarantee",
    description:
      "Every paint job we complete is covered for a full five years. If our workmanship fails within that time, we fix it at no charge.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every crew member follows EPA Lead-Safe Certified practices on older homes. No shortcuts on containment or cleanup — ever.",
  },
  {
    icon: faCalendarCheck,
    title: "No Contracts. No Lock-In.",
    description:
      "There's no subscription or lock-in required to work with us. We earn your business with every project — not by holding you hostage with a contract.",
  },
  {
    icon: faStar,
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every painting company in Central Texas makes promises. We back ours in writing — with upfront pricing, EPA Lead-Safe Certified crews, and a 5-Year Workmanship Guarantee on every job we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 350+ verified Google reviews</span>
          </div>
        </div>
