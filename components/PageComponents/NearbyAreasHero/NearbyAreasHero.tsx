...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Painting Services in ${cityName}, TX`;
  const displayDesc     = description ??
    `Brushcraft Painting Co. provides fast, reliable interior and exterior painting to ${cityName} and all surrounding communities. EPA Lead-Safe Certified crews, upfront pricing, 5-Year Workmanship Guarantee on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+18309007400" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
