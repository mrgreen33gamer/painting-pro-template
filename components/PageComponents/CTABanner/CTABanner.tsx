...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Brushcraft · Central Texas",
  badgeA = "Prep First",
  badgeB = "Cabinets",
  badgeC = "Exterior",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="400" height="400" viewBox="0 0 24 24" fill="currentColor"><path d="M7 3h10v6H7V3zm-1 8h12l-1 10H7L6 11zm3 2v6h2v-6H9zm4 0v6h2v-6h-2z" opacity="0.85"/></svg>
      </motion.div>
