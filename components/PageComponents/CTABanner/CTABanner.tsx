...
export default function CTABanner({
  ...
  subline   = "Free estimates available. Upfront pricing — no hidden fees. Call now or request a free estimate online.",
      ...
      <div className={styles.inner}>
        ...
        >
          <span className={styles.eyebrow}>
            ...
            Texas Hill Country Painting Experts Since 2014
          </span>
