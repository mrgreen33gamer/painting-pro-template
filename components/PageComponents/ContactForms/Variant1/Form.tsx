...
const SERVICES = [
  { icon: faPaintRoller,   label: 'Interior Painting' },
  { icon: faHouseChimney,  label: 'Exterior Painting' },
  { icon: faSwatchbook,    label: 'Cabinet Refinishing' },
  { icon: faBuilding,      label: 'Commercial Painting' },
  { icon: faPalette,       label: 'Color Consultation' },
  { icon: faHammer,        label: 'Drywall Repair' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'EPA Lead-Safe Certified' },
  { icon: faStar,         text: '4.9★ · 350+ reviews' },
];
      ...
      <div className={styles.inner}>
        ...
        <motion.div className={styles.header}
          ...
          <p className={styles.subtitle}>
            Tell us about your project and we'll have someone reach out — <strong>upfront quote, no pressure</strong>.
          </p>
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A Brushcraft Painting Co. team member will reach out shortly. Keep an eye on your inbox and phone.
                </p>
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  <div className={styles.fieldsSection}>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v1r-message">Describe the Project</label>
                      <textarea id="v1r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What needs to be painted? What's your timeline?" rows={2}
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+18309007400"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (830) 900-7400', section: 'ContactForm-V1' })}>
                          Call (830) 900-7400
                        </a>
                      </span>
                    </div>
