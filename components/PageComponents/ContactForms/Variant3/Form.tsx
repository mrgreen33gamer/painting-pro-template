...
const TIME_PREFS = ['Morning (7am–12pm)', 'Afternoon (12pm–5pm)', 'Evening (5pm–7pm)', 'Flexible – ASAP'];

const FIELDS = [
  { num: '01', id: 'v3-name',    name: 'name',    type: 'text',  label: 'Full Name',     icon: faUser,        placeholder: 'Jane Smith',           required: true  },
  { num: '02', id: 'v3-phone',   name: 'phone',   type: 'tel',   label: 'Phone Number',  icon: faPhone,       placeholder: '(830) 555-0100',        required: true  },
  { num: '03', id: 'v3-email',   name: 'email',   type: 'email', label: 'Email Address', icon: faEnvelope,    placeholder: 'jane@example.com',       required: true  },
  { num: '04', id: 'v3-address', name: 'address', type: 'text',  label: 'Project Address',icon: faLocationDot, placeholder: '123 Main St, New Braunfels TX', required: false },
];
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>Fill in the fields below and we'll build a custom project quote for you.</p>
          </div>
                ...
                <motion.div className={styles.numberedField}
                  ...
                  <div className={styles.fieldInner}>
                    ...
                    <textarea id="v3-message" name="message" className={`${styles.input} ${styles.textarea}`}
                      placeholder="What needs to be painted? Interior, exterior, cabinets? Any specific colors in mind?" rows={3}
