...
const SERVICES = [
  { icon: faPaintRoller,  label: 'Interior Painting',   sub: 'Walls, ceilings, trim, cabinetry' },
  { icon: faHouseChimney, label: 'Exterior Painting',   sub: 'Siding, trim, fascia, full repaints' },
  { icon: faSwatchbook,   label: 'Cabinet Refinishing', sub: 'Sprayed finishes, hardware swaps' },
  { icon: faBuilding,     label: 'Commercial Painting', sub: 'Offices, retail, multi-unit properties' },
  { icon: faPalette,      label: 'Color Consultation',  sub: 'In-home color guidance & samples' },
  { icon: faHammer,       label: 'Drywall Repair',      sub: 'Cracks, holes, water damage, prep' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A Brushcraft Painting Co. team member will reach out about your <strong>{selectedService}</strong> project.
                  </p>
                ...
                <motion.div key="step2" custom={dir} variants={slideVariants}
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v4r-message">Describe the Project</label>
                      <textarea id="v4r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" rows={3}
                        placeholder={`Tell us about your ${selectedService.toLowerCase()} project.`}
