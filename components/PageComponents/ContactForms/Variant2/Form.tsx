          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <p className={styles.quoteText}>
                "Upfront price. Show up on time. Paint it right. That's all anyone ever wants — and that's exactly what we do."
              </p>
              <span className={styles.quoteAttrib}>— Brushcraft Painting Co., New Braunfels TX</span>

              <div className={styles.panelStats}>
                {[
                  { val: '1,800+', lbl: 'Homes Painted' },
                  { val: '4.9★',   lbl: 'Google Rating' },
                  { val: '12+',    lbl: 'Years Local' },
                ].map(s => (
              ...
              <div className={styles.panelBadges}>
                {['Free Estimates', '5-Year Guarantee', 'No Contracts', 'EPA Lead-Safe Certified'].map(b => (
                ...
                <motion.div key="form" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                  ...
                  <div className={styles.urgencyRow}>
                    <button type="button"
                      ...
                      {urgent ? "🔴 Marked time-sensitive — we'll prioritize your call" : 'Mark as urgent / time-sensitive'}
                    </button>
                  </div>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v2r-message">Describe the project</label>
                      <textarea id="v2r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What needs to be painted?" rows={3}
