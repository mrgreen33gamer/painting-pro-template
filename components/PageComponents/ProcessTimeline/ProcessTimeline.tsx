      ...
      <div className={styles.container}>
        ...
        >
          ...
          <h2 className={styles.title}>
            Done Right in <span className={styles.accent}>4 Simple Steps</span>
          </h2>
          <p className={styles.sub}>
            No runaround. No hidden charges. Just clean, professional painting from estimate to final walkthrough.
          </p>
        </motion.div>
